    ...
    return (
        <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[800px] bg-red-950/15 rounded-[100%] blur-[120px] animate-pulse-slow" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[600px] bg-rose-950/10 rounded-full blur-[120px]" />
                <div className="absolute top-[20%] left-[-10%] w-[600px] h-[600px] bg-red-950/10 rounded-full blur-[120px]" />
            </div>
            ...
            <div className="relative z-10 text-center px-4 md:px-8 max-w-6xl mx-auto w-full">
                ...
                >
                    <div className="inline-flex items-center px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl text-xs sm:text-sm font-medium text-red-300 tracking-[0.2em] shadow-[0_0_30px_rgba(239,68,68,0.15)] uppercase">
                ...
                <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-white mb-8 leading-[0.9] w-full flex flex-col items-center">
                    ...
                    <m.span
                        ...
                        className="block w-full text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-500 to-red-800 pb-4 filter drop-shadow-[0_0_30px_rgba(239,68,68,0.25)]"
                    >
                        VIDEO EDITOR
                    </m.span>
                </h1>
                ...
                >
                    Turning raw footage into visual stories — with style, precision, and a touch of <span className="text-white font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">creative magic</span>.
                </m.p>
