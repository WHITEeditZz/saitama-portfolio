  ...
  return (
    <section className="relative w-full py-20 px-4 overflow-hidden">
      ...
      >
        ...
        {/* Animated Ambience */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-red-950/20 blur-[120px] rounded-full animate-pulse z-0" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-rose-950/20 blur-[100px] rounded-full z-0 opacity-50" />
        ...
        <div className="relative z-10 p-10 md:p-16 flex flex-col items-center text-center">
          ...
          {/* Glowing Badge */}
          <div className="inline-block px-4 py-1.5 rounded-full border border-red-500/20 bg-red-500/10 backdrop-blur-md mb-8 shadow-[0_0_20px_rgba(239,68,68,0.1)]">
            <span className="text-xs md:text-sm font-semibold text-red-300 tracking-widest uppercase">
